        ...
        const createPostCard = (postData) => {
            ...
            // MODIFICAÇÃO: Converte postData.likes para um número para garantir que não seja uma string de UID.
            const likesCount = Number(postData.likes) || 0; 
        ...
        const fetchPosts = async (searchTerm = '') => {
            ...
            try {
                ...
                snapshot.forEach(doc => {
                    ...
                    // MODIFICAÇÃO: Garante que postData.likes seja um número ao buscar do Firestore
                    postData.likes = Number(postData.likes) || 0; 
        ...
        // Adicionado: Lógica de proteção da página: verifica o estado de autenticação
        auth.onAuthStateChanged(async (user) => {
            ...
            if (currentUser) {
                ...
                fetchPosts(); // Chama fetchPosts apenas se o usuário estiver autenticado
            } else {
        ...
        logoutBtn.addEventListener('click', async () => {
            try {
                await auth.signOut();
                showNotification('Você foi desconectado. Redirecionando para a página de login.', "success");
                setTimeout(() => {
        ...
        homeLink.addEventListener('click', (e) => {
            ...
            // Redireciona para home.html mesmo se a pesquisa for resetada
        ...
        feedSection.addEventListener('click', async (event) => {
            ...
            if (event.target.closest('.like-btn')) {
                ...
                try {
                    ...
                    let likes = Number(postData.likes) || 0; // Garante que likes seja um número ao ser lido do Firestore   
